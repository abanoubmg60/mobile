...
class ChessboardSettings {
  ...
  /// Whether multiple consecutive premoves can be queued.
  final bool multiplePremoves;
  ...
  bool operator ==(Object other) {
    ...
    return other is ChessboardSettings &&
        ...
        other.multiplePremoves == multiplePremoves &&
  ...
  ChessboardSettings copyWith({
    ...
    return ChessboardSettings(
      ...
      multiplePremoves: multiplePremoves ?? this.multiplePremoves,
